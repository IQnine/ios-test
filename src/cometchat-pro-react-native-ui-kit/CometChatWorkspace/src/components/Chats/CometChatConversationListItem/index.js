...
class CometChatConversationListItem extends React.Component {
    ...
    try {
      ...
      if (diffTimestamp < 24 * 60 * 60 * 1000) {
        ...
        if (Platform.OS === 'android' && timestamp !== 'Yesterday') {
          ...
          timestamp = moment(messageTimestamp).format('h:mm A');
        }
        ...
        //   day: '2-digit',
        // });
        timestamp = moment(messageTimestamp).format('ll')
      } else {
        // timestamp = messageTimestamp.toLocaleDateString('en-US', {
        //   year: '2-digit',
        //   month: '2-digit',
  ...
  render() {
    ...
    if (this.state.lastMessage) {
      lastMessageTimeStamp = (
        <Text style={[styles.itemLastMsgTimeStyle, { color: this.props.conversation.unreadMessageCount ? this.props.primaryColor : Colors.grey1 }]} numberOfLines={1}>
        ...
        <TouchableOpacity
          ...
          <View style={styles.itemThumbnailStyle}>
            <CometChatAvatar
              ...
              borderWidth={0}
              name={this.get_decrypted_name(this.props.conversation.conversationWith?.name)}
            />
            {presence}
          </View>
          <View
            ...
            <View
              ...
              <Text numberOfLines={1} className='font-InterMedium font-medium' style={styles.itemNameStyle}>
                {this.get_decrypted_name(this.props.conversation.conversationWith?.name)}
              </Text>
            ...
            <View
              ...
              <View className='flex w-[90%]'>
                <Text numberOfLines={1} style={[styles.itemLastMsgTimeStyle, { color: Colors.grey1 }]}>
