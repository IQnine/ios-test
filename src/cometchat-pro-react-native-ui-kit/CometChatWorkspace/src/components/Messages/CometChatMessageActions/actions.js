...
export default (props) => {
  ...
  if (
    ...
    sendMessage = (
      <TouchableOpacity
        ...
        <FeatherIcon name="message-circle" size={actionIconSize} color={Colors.primaryColor}/>
  ...
  let deleteMessage = (
    <TouchableOpacity
      ...
      <IonIcon name="ios-trash-outline" size={actionIconSize} color={Colors.primaryColor}/>
  ...
  let editMessage = (
    <TouchableOpacity
      ...
      <MCIIcon name="square-edit-outline" size={actionIconSize} color={Colors.primaryColor}/>
