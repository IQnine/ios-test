...
const CometChatSenderTextMessageBubble = (props) => {
  ...
  return (
    <View style={[style.container,{ backgroundColor: props.messageId == props.message.id ? Colors.fieldGrayColor : '#0000'}]}>
      <TouchableWithoutFeedback
        onLongPress={() => {
          props.actionGenerated(actions.OPEN_MESSAGE_ACTIONS, message);
        }}>
        <View style={[style.messageWrapperStyle,{backgroundColor:primaryColor}]}>{messageText}</View>
      </TouchableWithoutFeedback>
