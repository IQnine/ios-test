...
export default class ComposerActions extends Component {
  ...
  checkRestrictions = async () => {
    ...
    this.setState({
      ...
      snapPoints: [height * 60 * heightRatio, 100],
    });
  };
  ...
  TakePhotoOption = () => {
    return (
      <TouchableOpacity
        ...
        <EvilIcon name="camera" size={35} color={Colors.blackColor50}/>
        <Text style={{ fontSize: 18, marginLeft: 5, fontWeight: '500',color:Colors.blackColor50,marginTop:3 }}>
          Take Photo
        </Text>
      </TouchableOpacity>
    );
  ...
  TakeVideoOption = () => {
    return (
      <TouchableOpacity
        ...
        <IonIcon name="videocam-outline" size={30} color={Colors.blackColor50}/>
        <Text
          style={{
            fontSize: 18,
            marginLeft: 10,
  ...
  DocumentOption = () => {
    return (
      <TouchableOpacity
        ...
        <IonIcon name="ios-folder-outline" size={30} color={Colors.blackColor50}/>
  ...
  StickerOption = () => {
    return (
      <TouchableOpacity style={style.actionButtonContainer}>
        <MCIIcon name="sticker-circle-outline" size={30} color={Colors.blackColor50}/>

        <Text
          style={{ fontSize: 18, marginLeft: 10, fontWeight: '500',color:Colors.blackColor50, marginTop:3 }}
  ...
  CreatePollOption = () => {
    return (
      <TouchableOpacity
        ...
        <MCIIcon name="comment-plus-outline" size={30} color={Colors.blackColor50}/>
